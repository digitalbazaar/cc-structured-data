...
/**
 * Analyzes the CommonCrawl dataset for structured data expressed as 
 * RDFa, Microdata or Microformats.
 * 
 * @author Manu Sporny <msporny@digitalbazaar.com>
 * @author Steve Salevan <steve.salevan@gmail.com> (original HelloWorld author)
 */
public class StructuredDataAnalyzer 
{
   ...
   public static void main(String[] args) throws IOException 
   {
      ...
      conf.setMapperClass(FeatureCountMapper.class);
      conf.setCombinerClass(FeatureCountReducer.class);
      conf.setReducerClass(FeatureCountReducer.class);

      // Tells Hadoop mappers and reducers to pull dependent libraries from
      // those bundled into this JAR.
      conf.setJarByClass(StructuredDataAnalyzer.class);
